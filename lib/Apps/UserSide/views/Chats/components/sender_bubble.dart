    ...
    child: Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            "${data['msg']}".text.color(data['uid'] == currentUser!.uid ? whiteColor : darkFontGrey).size(16).make(),
            10.heightBox,
            time.text
                .color(data['uid'] == currentUser!.uid
                    ? whiteColor.withAlpha((0.5 * 255).toInt())
                    : darkFontGrey.withAlpha((0.5 * 255).toInt()))
                .make()
          ],
        ),
      ),
